global outposix "out_first92R_v1"
...
decodeds using ../data/tlsa03o_de,gen(../tmp/xx.dta)
...
myRecode2 B1_5_NEW,gen(childx) 

table childx B1_5_NEW,missing
myRecode2 B1_1_NEW ,gen(x1) base(0)
myRecode2 B1_2_NEW ,gen(x2) base(0)
myRecode2 B1_3_NEW ,gen(x3) base(0)
myRecode2 B1_4_NEW ,gen(x4) base(0)

gen tmp=x1+x2+x3+x4
 gen child=childx
 replace child=0 if tmp==0 & childx==1
...
destring A192,replace
recode A192 (1/2=1)(3/6=0)(nonmissing=.),gen(mar)
label variable mar ""
label variable mar "是否單身"
label define mar 0 "單身" 1 "非單身"
label value mar mar

tab2 A192 mar,missing
...
merge 1:1 qtype ser_no4 using ../data/bkgrd2003r_de,keepusing(SEX AGE_2003 EDUC_DE)
drop if _merge==2
//年齡
...
save ../transfer/elder92R,replace
